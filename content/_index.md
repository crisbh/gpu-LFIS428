...
## Contenidos
- Introducción a CUDA y la programación heterogénea
- Invocación de kernels y organización de los threads
...
## Bibliografía
- J. Han & B. Sharma, Learn CUDA Programming, Packt Publishing, 2019.
- J. Cheng, M. Grossman & T. McKercher, Professional CUDA C Programming, Wrox, 2014.
- B. Schmidt, J. González-Domínguez, C. Hundt & M. Schlarb, Parallel Programming: Concepts and Practice, Morgan Kaufmann, 2017.
- B. Tuomanen, Hands-On GPU Programming with Python and CUDA, Packt Publishing, 2018.
