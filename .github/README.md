...
Materiales del curso *Programación en GPUs* (LFIS428) impartido en el IFA-UV.
...
## Course website
The [course website](https://crisbh.github.io/gpu-LFIS428/) is deployed via github actions. The build action will be triggered automatically by commits to `main`.
